...
class HomeActivityPresenter(viewPassed: HomeActivityContract.View, modelPassed: HomeActivityContract.Model, context : Context): HomeActivityContract.Presenter{
